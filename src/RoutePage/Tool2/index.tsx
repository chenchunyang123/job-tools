    ...
    <div className={styles.tool2}>
      <div className={styles.tool2_top}>
        <div className={styles.tool2_topLeft}>
          <TextArea
            ...
            value={topLeftJson}
            onChange={(e) => setTopLeftJson(e.target.value.trim())}
            {...commonConfig}
          />
        </div>
        <div className={styles.tool2_topRight}>
          <TextArea
            ...
            value={topRightJson}
            onChange={(e) => setTopRightJson(e.target.value.trim())}
            {...commonConfig}
          />
        </div>
      </div>
      ...
      <div className={styles.tool2_bottom}>
        <TextArea
          placeholder="这里是结果"
          value={bottomJson}
          onChange={(e) => setBottomJson(e.target.value.trim())}
          {...commonConfig}
        />
      </div>
    </div>
